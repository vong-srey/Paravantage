...
<div id="main">
	...
	<div id="content">
		...
		<div id="left">
			...
			<span id="bobRead" style="visibility: hidden; color: white; font-size: 13pt;">read=0</span>
			<h3>
				QUESTION: &nbsp;&nbsp;&nbsp;&nbsp; 
					<span id="BobQ1"></span>
		...
		<div id="right">
			<div style="margin-left:50px">
				...
				<span id="vpRead" style="visibility: hidden; color: white; font-size: 13pt;">read=1</span>
				<h3>
					QUESTION:&nbsp;&nbsp;&nbsp;&nbsp; 
						<span id="vpQ1"></span>
